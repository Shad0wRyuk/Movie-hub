...
fetch(json_url)
    ...
    .then((data) => {
        data.forEach((item, i) => {
            ...
            let { name, imdb, date, sposter, bposter, genre, url } = item;
    ...
    `;
        ...
        search_input.addEventListener('keyup', () => {
            ...
            for (let index = 0; index < a.length; index++) {
                ...
                let Textvalue = a[index].textContent || a[index].innerText;
